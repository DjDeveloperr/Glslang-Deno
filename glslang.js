...
var document = {};
const WASM_BINARY = decode(WASM_BASE64);
  ...
  return (
    function (Module) {
      ...
      function ha() {
        ...
        a ||
          D("Assertion failed: Cannot call unknown function convert_glsl_to_spirv, make sure it is exported");
        return a;
      }
      function aa(a) {
      ...
      var la = "undefined" !== typeof TextDecoder
      ...
      c.wasmMemory
        ? E = c.wasmMemory
        : E = new WebAssembly.Memory({ initial: na / 65536 });
      E && (J = E.buffer);
      na = J.byteLength;
      ma(J);
      C[84916] = 5582704;
      function K(a) {
        for (; 0 < a.length;) {
          ...
          if ("function" == typeof b) b();
            ...
            var d = b.J;
            "number" === typeof d
              ? void 0 === b.H ? c.dynCall_v(d) : c.dynCall_vi(d, b.H)
      ...
      var U = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
      ...
      function Da(a, b, d, e) {
        function g(a, b, d) {
          for (
            a = "number" === typeof a ? a.toString() : a || ""; a.length < b;
          ) {
            a = d[0] + a;
          }
          return a;
        ...
        function z(a) {
          ...
          return 0 >= h(n(new Date(a.getFullYear(), 0, 4)), a)
            ? 0 >= h(b, a) ? a.getFullYear() + 1 : a.getFullYear()
            : a.getFullYear() - 1;
        }
        var m = C[e + 40 >> 2];
        e = {
        ...
        g: function (a, b, d, e) {
          try {
            for (var g = 0, f = 0; f < d; f++) {
              for (
                var h = C[b + 8 * f >> 2], n = C[b + (8 * f + 4) >> 2], z = 0;
                z < n;
                z++
              ) {
                var m = H[h + z], l = za[a];
                0 === m || 10 === m
                  ? ((1 === a ? x : y)(I(l, 0)), l.length = 0)
                  : l.push(m);
              }
              g += n;
            }
        ...
        Ha = function () {
          ...
          function d(a) {
            return xa().then(function (a) {
              return WebAssembly.instantiate(WASM_BINARY, e);
            }).then(a, function (a) {
          ...
          (function () {
            if (
              A || "function" !== typeof WebAssembly.instantiateStreaming ||
              ta() || "function" !==
              typeof fetch
            ) {
              return d(b);
            }
            Promise.resolve(WASM_BINARY).then(function (a) {
              return WebAssembly.instantiate(a, e).then(b, function (a) {
